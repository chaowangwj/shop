    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aParent', models.ForeignKey(blank=True, to='order.AreaInfo', null=True)),
            ],
            options={
                'db_table': 'areainfo',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extra', models.CharField(max_length=20, null=True, blank=True)),
                ('goods', models.ForeignKey(to='order.Goods')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='user',
            field=models.ForeignKey(to='order.UserInfo'),
        ),
        migrations.AddField(
            model_name='orders',
            name='userOrder',
        ...
        migrations.AddField(
            model_name='goods',
            name='goodSort',
            field=models.ForeignKey(to='order.GoodSort'),
        ),
        migrations.AddField(
            model_name='cart',
            name='userCart',
